...
// Remember camera coordinate system is Left Handed
// Models are Right Handed 
...
const QMatrix4x4 &Camera3D::toMatrix()
{
  if (m_dirty)
  {
	...
	//this will move us from being with respect to the world to being
	//with respect of the camera. 
	//instead of forming the matrix and inverting it, build it inverted. 
